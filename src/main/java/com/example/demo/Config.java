...
public class Config {
	...
	public Config(JobRepository jobRepository, PlatformTransactionManager transactionManager,
	...
	public LineMapper<Customer> lineMapper() {
		...
		lineTokenizer.setNames("id", "firstName", "lastName", "email", "salary", "age", "dob");
